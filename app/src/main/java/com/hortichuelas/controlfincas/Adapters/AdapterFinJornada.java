...
public class AdapterFinJornada extends RecyclerView.Adapter<AdapterFinJornada.ViewHolder> {
    ...
    public AdapterFinJornada(Context context, ArrayList<Tareas> arrayList, TextView id, TextView name, TextView tipo, AlertDialog alert) {
